...
#
# Combine hints into a non-redundant set. The score field (6th column) in the
# output file tracks how many hints were combined, i.e., coverage. This
# coverage is computed separately for hints corresponding to different seed
# loci. The representative coverage of a hint is the maximum of coverages in
# all loci containing the given hint. The representative alignment score of a
# combined hint is the maximum from the scores of corresponding redundant
# hints.
# ==============================================================
...
def parseCmd():
    ...
    parser = argparse.ArgumentParser(description='Combine hints into \
        a non-redundant set. The score field (6th column) in the output file \
        tracks how many hints were combined, i.e., coverage. This coverage is \
        computed separately for hints corresponding to different seed loci. \
        The representative coverage of a hint is the maximum of coverages in \
        all loci containing the given hint. The representative alignment \
        score of a combined hint is the maximum from the scores of \
        corresponding redundant hints.')

    parser.add_argument('input', metavar='spaln.gff', type=str,
                        help='Input with raw hints generated by the Spaln \
        boundary scorer')
